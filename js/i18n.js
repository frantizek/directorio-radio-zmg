...
var translations = {
  es: {
    ...
    "auth.token_why": "Inicia sesi\u00f3n para editar el directorio. Tus cambios se guardan como un pull request en GitHub.",
    "auth.token_help": "Pega un personal access token (fine-grained) con permisos Contents y Pull requests sobre el repositorio.",
    "auth.token_how": "C\u00f3mo crear el token",
    ...
    "error.422": "Validaci\u00f3n rechazada por GitHub (rama o PR duplicado).",
    "error.rate_limit": "L\u00edmite de peticiones de GitHub alcanzado. Espera unos minutos e int\u00e9ntalo de nuevo.",
    "error.conflict": "Conflicto con el estado actual del repositorio. Recarga la p\u00e1gina e int\u00e9ntalo de nuevo.",
    "error.duplicate": "Ya existe una estaci\u00f3n con esa frecuencia en la misma banda.",
    "error.incomplete": "Completa al menos el nombre y la frecuencia de la estaci\u00f3n.",
    ...
    "edit.saved_direct": "Cambios guardados directamente en la rama principal.",
  ...
  en: {
    ...
    "auth.token_why": "Sign in to edit the directory. Your changes are saved as a pull request on GitHub.",
    "auth.token_help": "Paste a fine-grained personal access token with Contents and Pull requests permissions on the repository.",
    "auth.token_how": "How to create the token",
    ...
    "error.422": "Validation rejected by GitHub (duplicate branch or PR).",
    "error.rate_limit": "GitHub rate limit reached. Wait a few minutes and try again.",
    "error.conflict": "Conflict with the current repository state. Reload the page and try again.",
    "error.duplicate": "A station with that frequency already exists in the same band.",
    "error.incomplete": "Fill in at least the station name and frequency.",
    ...
    "edit.saved_direct": "Changes saved directly to the main branch.",
